let b1=document.getElementById("1");
    ...
    let firstser=document.getElementById("firstser");
let firstimg=document.getElementById("firstimg");
let fih=firstimg.height;
fih=fih/2;
let str=fih+"px";
firstser.style.marginTop=str;
//
let secondser=document.getElementById("secondser");
let secondimg=document.getElementById("secondimg");
let sih=secondimg.height;
sih=sih/2;
let str2=sih+"px";
secondser.style.marginTop=str2;
//
let thirdser=document.getElementById("thirdser");
let thirdimg=document.getElementById("thirdimg");
let tih=thirdimg.height;
tih=tih/2;
let str3=tih+"px";
thirdser.style.marginTop=str3;
//
let fourthser=document.getElementById("fourthser");
let fourthimg=document.getElementById("fourthimg");
let foih=fourthimg.height;
foih=foih/2;
let str4=foih+"px";
fourthser.style.marginTop=str4;
//
let introcard1id=document.getElementById("introcard1id");
let temp1=document.getElementById("temp1");
temp1.addEventListener("mouseover",typeWriter1);
var i1 = 0;
var txt1 = 'Corporate Internet Bandwidth Allocation, Advance Routing and Bandwidth Management, Network Operation Centre Functions';
...
var i4 = 0;
var txt4 = 'We are providing different kind of wireless solutions, Point to point connectivity, Base Station setup, Nstreme/ Nstreme2 connectivity etc.';
